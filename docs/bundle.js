(function (factory) {
  ...
  function fdValue(value, force = false) {
  ...
  const mapFn = (item, itemFn, inputs = {}, index, keyFn) => {
      ...
      if (typeof itemFn === 'function') {
          ...
          return Object.assign({}, itemFn(Object.assign({}, inputOverride, { index })), { fdKey: skopedKeyFn(newItem) });
      }
      return Object.assign({}, itemFn, { textValue: itemFn.textValue(isPrim ? newItem.value : item), fdKey: skopedKeyFn(newItem) });
  };
